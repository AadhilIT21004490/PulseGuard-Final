  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((response) => {
        ...
        projectsTableData[0].values = response.data.I;
        projectsTableData[1].values = response.data.II;
        projectsTableData[2].values = response.data.III;
        projectsTableData[3].values = response.data.aVF;
        projectsTableData[4].values = response.data.aVR;
        projectsTableData[5].values = response.data.aVL;
        projectsTableData[6].values = response.data.V1;
        projectsTableData[7].values = response.data.V2;
        projectsTableData[8].values = response.data.Prediction === 0 ? "Normal" : response.data.prediction === 1 ? "LOW RISK" : "HIGH RISK";
      })
      .catch((err) => {
