...
export function Home() {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://127.0.0.1:5000/hattack/latest")
      .then((response) => {
        ...
        projectsTableData[2].values = response.data.Heart_Rate;
        projectsTableData[3].values = response.data.Systolic_BP;
        projectsTableData[4].values = response.data.Diastolic_BP;
